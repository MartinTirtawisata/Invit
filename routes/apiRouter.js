...
router.get('/seller/:id',jsonParser, (req, res) => {
...
router.put('/seller/:id', jsonParser, (req, res) => {
...
router.delete('/seller/:id', jsonParser, (req, res)=> {
...
router.post('/products', jsonParser, (req, res) => {
    //We have to pass in the seller ID
    Seller.findById(req.body.id).then(seller => {
        
        Product.create({
            seller: req.body.seller_id,
            product_name: 'iPhone 10',
            product_img: 'some image',
            product_desc: "Most advacned iPhone yet"
